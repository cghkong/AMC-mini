...
def parse_args(parser):
    ...
    parser.add_argument('--train_episode', default=120, type=int, help='train iters each timestep')
...
class in_args:
    def __init__(self):
        ...
        self.preserve_ratio=0.5
        self.lbound=0.2
        self.rbound=1
        self.reward='acc_reward'
        self.data_root='dataset/imagenet'
        self.ckpt_path = './checkpoints/mobilenet_imagenet.pth'
        self.seed = 2018
        ...
        self.tau=0.1
        self.init_delta=0.5
        self.delta_decay=0.95
        #training
        self.max_episode_length=1e9
        self.output='./logs'
        self.debug='debug'
        self.init_w=0.003
        self.train_episode=160
        self.epsilon=50000
        self.n_gpu=1
        self.n_worker=8
        self.data_bsize=32
        ...
        self.use_new_input=False

class in_args_export:
    def __init__(self):
        self.job='export'
        self.suffix=None
        self.model='mobilenet'
        ...
        self.resume='default'
        self.ratios=None
        self.channels='3,24,48,96,80,192,200,328,352,368,360,328,400,736,752'
        self.export_path='./checkpoints/mobilenet_0.5flops_export.pth'
        self.use_new_input=False


if __name__ == "__main__":
    #args = parse_args()   #linux
    args = in_args()
    #args = in_args_export()
    print(args.job)
    ...
    if args.job == 'train':
        ...
        args.rmsize = args.rmsize * len(env.prunable_idx)  # for each layer，replay buffer
