...
class Actor(nn.Module):
    def __init__(self, nb_states, nb_actions, hidden1=400, hidden2=300):
        ...
        self.fc2 = nn.Linear(64, hidden1)
        self.fc3 = nn.Linear(hidden1, hidden2)
        self.fc4 = nn.Linear(hidden2, nb_actions)
        self.relu = nn.ReLU()
...
class Critic(nn.Module):
    def __init__(self, nb_states, nb_actions, hidden1=400, hidden2=300):
        ...
        self.fc11 = nn.Linear(nb_states, 64)
        self.fc12 = nn.Linear(nb_actions, 64)
        self.fc21 = nn.Linear(64, hidden1)
        self.fc22 = nn.Linear(hidden1, hidden2)
